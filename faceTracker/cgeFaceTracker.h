...
namespace CGE
{
    ...
    public:
        ...
        static void setupTracker(const char* modelfname,const char* trifname,const char* confname);
        ...
        */
        ...
        void drawMeshes(cv::Mat& dst, const cv::Scalar scalar = cv::Scalar(255, 255, 255, 255)) const;
        
        void drawFeature(cv::Mat& dst, CGEFaceFeature feature, bool cycle = true, const cv::Scalar scalar = cv::Scalar(255, 255, 255, 255)) const;
